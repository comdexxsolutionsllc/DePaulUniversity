...
abstract class Translator {
	...
	Translator(double tX, double tY, double tWidth, double tHeight,
			double tScaleFactor) {
		_tX = tX;
		_tY = tY;
		_tWidth = tWidth;
...
class TranslatorWE extends Translator {
	TranslatorWE(double tX, double tY, double tWidth, double tHeight,
			double tScaleFactor) {
...
class TranslatorEW extends Translator {
	TranslatorEW(double tX, double tY, double tWidth, double tHeight,
			double tScaleFactor) {
		super(tX, tY, tWidth, tHeight, tScaleFactor);
	}

	int getX(double x, double y, double width, double height) {
		return scale(_tX + _tWidth - x - width);
	}

	int getY(double x, double y, double width, double height) {
		return scale(_tY + _tHeight - y - height);
	}
...
class TranslatorNS extends Translator {
	TranslatorNS(double tX, double tY, double tWidth, double tHeight,
			double tScaleFactor) {
		super(tX, tY, tWidth, tHeight, tScaleFactor);
	}
...
class TranslatorSN extends Translator {
	TranslatorSN(double tX, double tY, double tWidth, double tHeight,
			double tScaleFactor) {
		super(tX, tY, tWidth, tHeight, tScaleFactor);
	}

	int getX(double x, double y, double width, double height) {
		return scale(_tX + _tHeight - y - height);
	}

	int getY(double x, double y, double width, double height) {
		return scale(_tY + _tWidth - x - width);
	}
