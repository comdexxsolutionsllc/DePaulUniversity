...
public class RoadTEST extends TestCase {
	...
	public void testConstructorAndAttributes() {
		...
		Assert.assertTrue(r1.getEndPosition() <= propertyBag
				.getRoadSegmentLengthMax());
		Assert.assertTrue(r1.getEndPosition() >= propertyBag
				.getRoadSegmentLengthMin());
		r1.setNextRoad(i1);
	...
	public void testDistanceToObstacle() {
		...
		Assert.assertEquals(r1.getCars().size(), 1);
		Assert.assertTrue(Util.isEquals(
				r1.distanceToObstacle(0.0, c1.getOrientation()),
				c1.getBackPosition()));
	}
}
