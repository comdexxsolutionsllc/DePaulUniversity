...
public class CarTEST extends TestCase {
	...
	public void testConstructorAndAttributes() {
		...
		Assert.assertTrue(c1.getBrakeDistance() <= propertyBag
				.getCarBrakeDistanceMax());
		Assert.assertTrue(c1.getBrakeDistance() >= propertyBag
				.getCarBrakeDistanceMin());
		Assert.assertTrue(c1.getLength() <= propertyBag.getCarLengthMax());
		Assert.assertTrue(c1.getLength() >= propertyBag.getCarLengthMin());
		Assert.assertTrue(c1.getMaxVelocity() <= propertyBag
				.getCarMaxVelocityMax());
		Assert.assertTrue(c1.getMaxVelocity() >= propertyBag
				.getCarMaxVelocityMin());
		Assert.assertTrue(c1.getStopDistance() <= propertyBag
				.getCarBrakeDistanceMax());
		Assert.assertTrue(c1.getStopDistance() >= propertyBag
				.getCarStopDistanceMin());
