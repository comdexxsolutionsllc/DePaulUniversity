...
import project.timeserver.TimeServer;
import project.timeserver.TimeServerLinked;
...
public class PropertyBag {
	...
	public String toString() {
		...
		b.append("Simulation run time (seconds)        [" + this.getRunTime()
				+ "]\n");
		b.append("Grid size (number of roads)          [row="
				+ this.getGridRow() + ",column=" + this.getGridColumn() + "]\n");
		String pattern = (this.getTrafficPattern() == TrafficType.ALTERNATING ? "Alternating"
				: "Simple");
		b.append("Traffic pattern                      [" + pattern + "]\n");
		b.append("Car entry rate (seconds/car)         [min="
				+ this.getCarGenerationDelayMin() + ",max="
				+ this.getCarGenerationDelayMax() + "]\n");
		b.append("Road segment length (meters)         [min="
				+ this.getRoadSegmentLengthMin() + ",max="
				+ this.getRoadSegmentLengthMax() + "]\n");
		b.append("Intersection length (meters)         [min="
				+ this.getIntersectionLengthMin() + ",max="
				+ this.getIntersectionLengthMax() + "]\n");
		b.append("Car length (meters)                  [min="
				+ this.getCarLengthMin() + ",max=" + this.getCarLengthMax()
				+ "]\n");
		b.append("Car maximum velocity (meters/second) [min="
				+ this.getCarMaxVelocityMin() + ",max="
				+ this.getCarMaxVelocityMax() + "]\n");
		b.append("Car stop distance (meters)           [min="
				+ this.getCarStopDistanceMin() + ",max="
				+ this.getCarStopDistanceMax() + "]\n");
		b.append("Car brake distance (meters)          [min="
				+ this.getCarBrakeDistanceMin() + ",max="
				+ this.getCarBrakeDistanceMax() + "]\n");
		b.append("Traffic light green time (seconds)   [min="
				+ this.getTrafficLightGreenTimeMin() + ",max="
				+ this.getTrafficLightGreenTimeMax() + "]\n");
		b.append("Traffic light yellow time (seconds)  [min="
				+ this.getTrafficLightYellowTimeMin() + ",max="
				+ this.getTrafficLightYellowTimeMax() + "]\n");
		return b.toString();
	}
}
