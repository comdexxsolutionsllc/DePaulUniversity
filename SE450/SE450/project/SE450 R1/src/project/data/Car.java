 ...
 * 
 * Comprises Length, Velocity, Break & Stop Distance, Front Position & Road
 * Position
 * 
 */
public interface Car {
	...
	/*
	 * If distace to nearest obstacle is <= brakeDistance, then the car will
	 * start to slow down (in meters)
	 */
	public double getBrakeDistance();

	/*
	 * If distance to nearest obstacle is == stopDistance, then the car will
	 * stop (in meters)
	 */
