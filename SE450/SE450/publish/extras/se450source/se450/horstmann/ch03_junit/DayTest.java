...
public class DayTest extends TestCase
{
   ...
   */
   public void testDaysFrom()
   {
      ...
      Day d3 = d2.addDays(n);
      assert d1.getYear() == d3.getYear();      
      assert d1.getMonth() == d3.getMonth();      
      assert d1.getDate() == d3.getDate();      
   }
