...
public final class TimeServerLinked extends Observable implements TimeServer {
	...
	private int _size;
	private Node _head;
	private volatile static TimeServer timeLinkedServer;
	...
	public static TimeServer getServer(){
		if (timeLinkedServer == null)
			timeLinkedServer = new TimeServerLinked();
		return timeLinkedServer;
	}
