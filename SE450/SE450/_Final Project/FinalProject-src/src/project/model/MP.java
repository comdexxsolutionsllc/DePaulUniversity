...
public class MP {
	...
	/*
	 * Car generation delay Each car source generates cars at a fixed rate, but
	 * the sources may vary. You should set the delay between car generations by
	 * each source to be a random number between the min and max chosen here.
	 */
	...
	/*
	 * default timestep is .1 seconds. This indicates how much model time
	 * elapses between each simulation step. You can use this to adjust the
